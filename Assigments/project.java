        ...
        public void main(String[] args) throws IOException {
            ...
            while ((linea = br.readLine()) != null) {
                ...
                for (int i = 1; i < ntiempos + 1; i++) {
                    ...
                    tiempos[i] = new tiempo(
                            Integer.parseInt(tiempo[0].split(":")[0]) * 60 + Integer.parseInt(tiempo[0].split(":")[1]),
                            Integer.parseInt(tiempo[1].split(":")[0]) * 60 + Integer.parseInt(tiempo[1].split(":")[1]));
                }
                Arrays.sort(tiempos);
                int mayor = 0;
                int tiempoMayor = 0;
                ...
                System.out.println("Day #" + (n++) + ": the longest nap starts at " + tiempoMayor / 60 + ":"
                        + (tiempoMayor % 60 < 10 ? ("0" + (tiempoMayor % 60)) : (tiempoMayor % 60 + ""))
                        + " and will last for " + (mayor < 59 ? (mayor / 60 + " hours and " + mayor % 60 + " minutes.")
                                : (mayor % 60 + " minutes.")));
            }
        }
    }
